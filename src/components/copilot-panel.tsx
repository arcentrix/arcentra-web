...
export function CopilotPanel() {
  ...
  const openFullChat = (prompt?: string) => {
    ...
    navigate(`/workspace/${encodeURIComponent(DEFAULT_WORKSPACE)}/chat${search}`)
  }
      ...
      <Sheet open={copilotOpen} onOpenChange={uiShellStore.setCopilotOpen}>
        ...
        >
          <SheetHeader className='border-b p-4 text-left'>
            ...
            <SheetDescription>
              Talk to your platform — ask about pipelines, deployments, agents, or generate config.
            </SheetDescription>
          </SheetHeader>
          ...
          <div className='flex flex-1 flex-col gap-4 overflow-y-auto p-4'>
            ...
            <div className='rounded-md border bg-muted/30 p-3 text-xs text-muted-foreground'>
              The full conversation experience lives in workspace chat. Pick a prompt above
              or open the full chat below to keep context across sessions.
            </div>
          </div>
          ...
          <div className='flex flex-col gap-2 border-t p-4'>
            ...
            <Button
              ...
              onClick={() => {
                uiShellStore.closeCopilot()
                navigate(`/workspace/${encodeURIComponent(DEFAULT_WORKSPACE)}/history`)
              }}
            >
