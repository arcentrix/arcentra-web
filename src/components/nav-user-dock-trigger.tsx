...
export function NavUserDockTrigger({
  expanded = false,
}: {
  expanded?: boolean;
}) {
  ...
  return (
    <Popover open={popoverOpen} onOpenChange={setPopoverOpen}>
      ...
      <Sheet open={profileOpen} onOpenChange={setProfileOpen}>
        <SheetContent className="flex w-[440px] max-w-[calc(100vw-64px)] flex-col gap-0 p-0 sm:max-w-[440px]">
          <form
                ...
                <div className="grid gap-2">
                  ...
                  <Input
                    ...
                    ref={(e) => {
                      ...
                      ref(e);
                      (
                        fullNameInputRef as React.MutableRefObject<HTMLInputElement | null>
                      ).current = e;
                    }}
